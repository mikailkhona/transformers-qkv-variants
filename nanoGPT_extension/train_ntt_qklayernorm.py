...
import hydra
from utils import get_dataloader, dotdict, get_cosine_warmp_lr
...
@hydra.main(config_path="./configs", config_name="config_nanogpt_qklayernorm.yaml")
def main(cfg):
    ...
    #Create dataloaders
    train_dataloader, val_dataloader = get_dataloader(train_data_path=data_dir_train, val_data_path=data_dir_eval, batch_size = cfg.batch_size, num_workers=1)
